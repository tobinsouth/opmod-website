...
function Header() {
    // TODO: Alter the user logo once logged in
          ...
          <div className="relative flex-1 lg:max-w-sm mr-2 sm:mr-4 lg:mr-6">
            <div className="relative w-full max-w-xs">
              <input autoComplete="off" type="text" className="w-full dark:bg-gray-950 form-input-alt h-9 pl-8 pr-3 focus:shadow-xl" placeholder="Search" />
                <svg className="absolute left-2.5 top-2.5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" aria-hidden="true" focusable="false" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet">
